/**
 * WeApp QRCode 微信小程序二维码生成库
 * 基于 qrcode-generator 修改适配小程序
 */
...
function drawQrcode(options) {
  options = options || {};
  options.typeNumber = options.typeNumber || -1;
  options.errorCorrectLevel = options.errorCorrectLevel || 'M';
  ...
  function createCanvas() {
    ...
    var cellSize = (size - margin * 2) / qrcode.getModuleCount();
